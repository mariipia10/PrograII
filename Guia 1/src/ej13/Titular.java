...
public class Titular {
    ...
    public Titular(String nombre, String apellido, Fecha fecha,Domicilio domi) {
        setNombre(nombre);
    ...
    public String toString() {
        return "Titular{" + "nombre=" + nombre + ", apellido=" + apellido + ", fechaNac=" + fechaNac + ", domicilio=" + domicilio + '}';
    }
